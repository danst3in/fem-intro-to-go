...
// 		// panic(err)
// 		// fmt.Println("Hey do something else") // unreachable due to panic
// 		// log.Fatalln(err)
// 	}

// 	// fmt.Println(err) // removed after scoping first error to "if block"

// 	// err := openFile() // removed after scoping 2nd error to "if block"
